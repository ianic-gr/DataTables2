...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    Datepicker: typeof import('./components/datatables/header/AdvancedFilters/fields/components/Datepicker.vue')['default']
    Expanded: typeof import('./components/examples/components/Expanded.vue')['default']
    Fields: typeof import('./components/datatables/header/AdvancedFilters/fields/index.vue')['default']
